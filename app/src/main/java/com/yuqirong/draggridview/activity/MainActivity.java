...
import com.yuqirong.draggridview.adapter.GridViewAdapter;
import com.yuqirong.draggridview.view.DragGridView;
import com.yuqirong.draggridview.view.DragGridView2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private DragGridView2 otherGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otherGridView = (DragGridView2) findViewById(R.id.otherGridView);
        list.add("杭州");
        list.add("宁波");
        list.add("上海");
        list.add("北京");
        ...
        list2.add("5");
        list2.add("6");
        GridViewAdapter mAdapter2 = new GridViewAdapter(this,list2);
